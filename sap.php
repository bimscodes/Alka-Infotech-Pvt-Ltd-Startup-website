...
<meta content='width=device-width, initial-scale=1.0' name='viewport'>
    ...
    <meta name="description" content="Alka Infotech is a promising web development company which hosts application development on cloud and offers Cloud App Development using latest Rackspace or amazon AWS cloud servers. We take care of complete design, development, testing & deployment." />
    <meta name="keywords" content="Cloud App Development, cloud computing app development, custom application development, mobile application development services, creative cloud app development. " />
    <meta property='og:url' content='application-development.html'/>
  ...
  <div  itemscope="" itemtype="http://data-vocabulary.org/Review-aggregate" style="display:none;background:#2F3C53;margin-top: 10px;color: #e1e1e1; margin-bottom:0px !important; padding:10px;text-align:center; font-size:15px;line-height:1.2em;"><span itemprop="rating" itemscope="" itemtype="http://data-vocabulary.org/Rating">Rated <span itemprop="average">5.0</span> out of <span itemprop="best">5.0</span> </span>for <span itemprop="itemreviewed">Mobile Development</span> by <span itemprop="votes">500</span>+ clients on over <span itemprop="count">1000</span>+ projects.</div>     
    <div itemscope="" itemtype="http://data-vocabulary.org/Review-aggregate" style="display:none;background:#2F3C53;margin-top: 10px;color: #e1e1e1; margin-bottom:0px !important; padding:10px;text-align:center; font-size:15px;line-height:1.2em;"><span itemprop="rating" itemscope="" itemtype="http://data-vocabulary.org/Rating">Rated <span itemprop="average">5.0</span> out of <span itemprop="best">5.0</span> </span>for <span itemprop="itemreviewed">Web Development</span> by <span itemprop="votes">800</span>+ clients on over <span itemprop="count">1500</span>+ projects.</div>    
  <div id='wrapper'>
      <div id='header'>
				<div class='container'>
...
<!--Page Content-->
	<div id='main' role='main' class="inner-template">	
            <div id='main-content-header' title="Application Development">
          <div class='container'>
            <div class='row'>
              <div class='col-sm-12'>
                <h1 class='title'>
                  ...
                  <div class="sidebar-collapse collapse">                   
                    <div class="box">
                      ...
                      <div class="list-group">
                          ...
                          <a class="list-group-item" href="application-development.php"><i class="fa-icon-angle-right fa-icon-fixed-width"></i>Application Development</a>
                      
                         <a class="list-group-item" href="application-management.php"><i class="fa-icon-angle-right fa-icon-fixed-width"></i>Application Maintanance</a>
                      
                          <a class="list-group-item" href="BusinessSolutions.php"><i class="fa-icon-angle-right fa-icon-fixed-width"></i>Business Process Solutions</a>
                      
                          <a class="list-group-item" href="Web_Design.php"><i class="fa-icon-angle-right fa-icon-fixed-width"></i>Design & Usability</a>
        ...
        <h3 class="title">Request a Resource</h3>

        <form onsubmit="return checkFile()" class="form form-validation" method="post" action="info@alkainfotech.com/application-development.php" enctype="multipart/form-data" >
...
<script>
		  ...
		  <div class="col-md-pull-3 col-sm-pull-4 col-sm-8 col-md-9">
            <div class='row'>
              <div class='col-sm-12'>               
                <div class='row'>
                  <div class='col-sm-12'>
                    <p class='lead lead-md text-center'>Alka Infotech helps you rediscover business along with your digital transformation journey <br><br>Our end to end SAP services are delivered through either a dedicated or a shared service model, which allows customers to leverage our skills and services in implementations, upgrades, rollouts and support areas. Our SAP services can be utilized in a pay as you use model, enabling clients to have a better control over the SAP management costs <br><br><br><br>
					</p>	
					</div>
                </div>
              </div>
			...
			<div class="page-header page-header-with-icon">               
				...
				<div class="col-sm-12">
                            <img class="img-responsive center-block img-rounded shadow-lg rounded" alt="Cras tempus ligula a tempor adipiscing" width="848" height="364" src="assets/images/sap.jpg">
                 </div>
      ...
      <br><br><br>
       <div class='row'>
                  <div class='col-sm-12'>
                    ...
                    <p class='lead lead-md text-center'>The best business software meets today’s needs and allows for future growth – without costly integration. SAP is recognised a Leader across its portfolio, so you don’t have to compromise
					</p>	
					</div>
                </div>
                <br><br><br>
   ...
   <div class="container">
                <div class="row">
				<div class="col-sm-3 ">
                          <h4 class="title text-center">ERP and Digital Core</h4>
                        <p>With SAP pay-as-you-go pricing model, it is possible for the company to effectively manage its cloud and IT costs. The company only pays for what it needs.  </p>
                        </div>
				<div class="col-sm-3">
                          <h4 class="title">CRM and Customer Experience</h4>
                        <p >Forrester names SAP Commerce Cloud a B2B and B2C Commerce Leader, saying it’s a "best fit for firms looking for an industrial-strength, fully functional commerce platform.
                        ...
                        <p>SAP Ariba is in the Leaders quadrant for both the Gartner 2018 Magic Quadrant for Strategic Sourcing Application Suites and the Gartner 2018 Magic Quadrant for Procure-to-Pay Suites. </p>
                        </div>
				<div class="col-sm-3">
                          <h4 class="title">HR and People Engagemen</h4>
                        <p>2018 analyst reports place SAP SuccessFactors solutions as a Leader in employee engagement, as well as core HR functions
      ...
      <div class="container">
			<div class="row">
				<div class="col-sm-6">
                          <h2 class="title">Will it break my budget?</h2>
                        <p>With SAP pay-as-you-go pricing model, it is possible for the company to effectively manage its SAP and IT costs. .<a href="contact_us.php">Contact us for pricing.</a> </p>
                        </div>
				<div class="col-sm-6">
                          <h2 class="title">Where do I start?</h2>
                        <p ><a href="contact_us.php">Contact us for pricing.</a>:- for help in selecting a cloud solution that will meet your company’s requirements	
...
{
            window.location.href = "application-development.html";
