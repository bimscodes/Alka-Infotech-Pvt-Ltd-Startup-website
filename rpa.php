		  ...
		  <div class="col-md-pull-3 col-sm-pull-4 col-sm-8 col-md-9">
            <div class='row'>
              <div class='col-sm-12'>               
                <div class='row'>
                  <div class='col-sm-12'>
                    <p class='lead lead-md text-center'>Robotic Process Automation (RPA) is a digital business software that allows the automation of tasks, complements the other offers in the IBM platform for digital companies. 
					</p>	
					</div>
                </div>
              </div>
			...
			<div class="page-header page-header-with-icon">               
				...
				<div class="col-sm-12">
                            <img class="img-responsive center-block img-rounded-half" alt="Cras tempus ligula a tempor adipiscing" width="800" height="364" src="assets/images/RPA-Benefits@2x.png">
                 </div>
				<div class="col-sm-12">
                          <h2 class="title text-center">Benifit Of RPA</h2>
                        <p class="text-center">
