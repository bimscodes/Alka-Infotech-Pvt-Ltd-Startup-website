...
<meta content='width=device-width, initial-scale=1.0' name='viewport'>
      ...
      <title> 
            Application Development Services | Cloud App Development      </title>
		  ...
		  <div class="col-md-pull-3 col-sm-pull-4 col-sm-8 col-md-9">
            <div class='row'>
              <div class='col-sm-12'>               
                <div class='row'>
                  <div class='col-sm-12'>
                    <p class='lead lead-md text-center'>Alka Infotech offers custom application development services to help align your <a href="BusinessSolutions.html" title="business processes">business processes</a>, improve process efficiency, and manage costs, productivity & deliverables.  Using Cloud infrastructure from Amazon Web Services & Rackspace, we develop and deploy secure & scalable cloud-based applications. We work across different industry segments powering different business functions through our innovative applications & solutions. 
					</p>	
					</div>
                </div>
              </div>
			...
			<div class="page-header page-header-with-icon">               
                  <h2 class="title">
                    Benefits of Cloud Based App                  
                  </h2>
                </div>
				<div class="col-sm-12">
                            <img class="img-responsive center-block img-rounded-half" alt="Cras tempus ligula a tempor adipiscing" width="848" height="364" src="assets/images/application-testing3.png">
                 </div>
				<div class="col-sm-12">
                          <h2 class="title text-center">Benefits of Cloud Based App</h2>
                        <p class="text-center">Alka Infotech develops applications with a carefully designed User Experience ensuring the applications are easy to use, useful and engaging to the end users.  Our team takes pain to understand the objectives, goals of the application and the target users, based on which the entire user experience is designed.</p>						
                        </div>
			</div>
			<div class="spacer"></div>
			<div class="row">
				<div class="col-sm-6">
                          <h2 class="title">Startups & SMEs</h2>
                        <p >We provide offshore product development</a> services & complete end-to-end support for startups & SMEs. We take care of managing the complete IT backbone allowing our clients to focus on their core business. We use cutting-edge technologies, creative design ideas and usability expertise mixed with your functional inputs to develop & deliver useful applications.</p>
                        </div>
				<div class="col-sm-6">
                          <h2 class="title">Enterprises</h2>
                        <p >Most enterprises face common challenges and problems such as:	
						
						</p>
						<p>We understand that and have worked with numerous enterprises to solve this repeatedly. With our experience & expertise, we build upon your specific business knowledge to develop & deliver custom solutions to your problems. We are aware that your business is consistently evolving and your application needs to keep up and hence the enterprise applications we deliver are flexible and open to changes.</p>
                        </div>
			</div>
