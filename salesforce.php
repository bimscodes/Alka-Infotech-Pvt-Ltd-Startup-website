		  ...
		  <div class="col-md-pull-3 col-sm-pull-4 col-sm-8 col-md-9">
            <div class='row'>
              <div class='col-sm-12'>               
                <div class='row'>
                  <div class='col-sm-12'>
                    <p class='lead lead-md text-center'>Building a cloud-powered business requires more than just giving your people access to new systems. To get the maximum value from an application, you need to understand how your workforce and your business benefit. That’s especially important when the application – like Salesforce – is so central to your bottom line. 
					</p>	
					</div>
                </div>
              </div>
			...
			<div class="page-header page-header-with-icon">               
				...
				<div class="col-sm-12">
                            <img class="img-responsive center-block img-rounded-half" alt="Cras tempus ligula a tempor adipiscing" width="400" height="364" src="assets/images/salesforce2.png">
                 </div>
				<div class="col-sm-12">
                          <h2 class="title text-center">Feature of Salesforce</h2>
                        <p class="text-center">
                        		...
                        		<div class="col-sm-12">
                         <div>
                         <span><h4>Sales</h4></span><span><p>The world’s #1 CRM solution gives your sales teams the power to close deals like never before with an array of cloud-based tools that increase productivity, keep pipeline filled with solid leads, and score more wins. No software. No hardware. No speed limit</p></span></div>
                        		...
                        		<div class="col-sm-12">
                         <div>
                         <span><h4>Service</h4></span><span><p>From call-center software to self-service portals, our service solutions enhance your customer service with more responsive, more intuitive, more flexible support that anticipates customer needs</p></span></div>
                        	...
                        	<div class="col-sm-12">
                         <div>
                         <span><h4>Desk.com</h4></span><span><p>All-in-one customer support app helps small businesses quickly offer personalized service on every channel.</p></span></div>
                        	...
                        	<div class="col-sm-12">
                         <div>
                         <span><h4>Marketing</h4></span><span><p>Make the most of every customer interaction — creating personalised, cross-channel customer journeys that deliver exceptional brand experiences across email, mobile, social, Web, and more.</p></span></div>
